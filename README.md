Discente: Paulo Henrique Schulz
...
O Arduino lê a posição do potenciômetro pelo pino A0.
O valor do potenciômetro é convertido em um ângulo.
O Arduino controla o servo motor pelo pino 9.
Ao girar o potenciômetro, o servo motor gira proporcionalmente.
